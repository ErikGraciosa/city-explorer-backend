...
app.get('/location', async(req, res) => {
  ...
  const locationLatLon = await fetch.get('https://us1.locationiq.com/v1/search.php?key=pk.8f2f37971e16b2ecb408e37871915515&q=Portland&format=json');
